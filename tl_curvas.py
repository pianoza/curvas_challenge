...
def process(args):
    ...
    if args.trans_encoding == 'word_embedding':
        ...
        # keep only ids at indices 2, 6, and 11
        word_embedding = word_embedding[[2, 6, 11]]
    ...
    # scheduler = CosineAnnealingLR(optimizer, T_max=args.max_epoch, eta_min=0)
    ...
    if args.resume:
        ...
        if args.dist:
            ...
            # keep only ids at indices 2, 6, and 11 in store_dict['organ_embedding']
            store_dict['organ_embedding'] = store_dict['organ_embedding'][[2, 6, 11]]
            model.load_state_dict(store_dict)
