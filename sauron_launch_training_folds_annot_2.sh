...
savepath='/home/kaisar/CURVAS_results_annotator_2'
...
for fold in 1 2 3 4 5; do
    ...
    docker run -it --shm-size=100GB --gpus '"device=3"' -v /home/kaisar:/home/kaisar -p 6006:6006 atlas:latest python -W ignore /home/kaisar/AbdomenAtlas/train_curvas.py \
                    --device="$device" \
    ...
    docker run -it --shm-size=100GB --gpus '"device=3"' -v /home/kaisar:/home/kaisar -p 6006:6006 atlas:latest python -W ignore /home/kaisar/AbdomenAtlas/test_curvas.py \
