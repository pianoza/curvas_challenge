...
class DiceLoss(nn.Module):
    # NOTE modifying only the list of organs 'new_list' could be enough for the challenge to keep the other
    # organs/channels as they are. 
    ...
    def forward(self, predict, target, name, TEMPLATE):
        ...
        for b in range(B):
            ...
            assert len(target_sum) == 3, 'target sum =! 3'  # 32 organs in the original, but curvas is 3
